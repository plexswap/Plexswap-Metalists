...
const COINGEKKO_BAD_TOKENS = [
  ...
  "0x3e3b357061103dc040759ac7dceeaba9901043ad"  // bad decimal
]
...
const CMC_BAD_TOKENS = [
  ...
  "0xcFA52F180538032402E0A2E702a4Da6fD1817fF5", // bad decimal
  "0xBb6CD639724417A20a7db0F45C1fb2fE532f490A", // bad symbol
  "0xBb6CD639724417A20a7db0F45C1fb2fE532f490A", // bad name
  "0xBb6CD639724417A20a7db0F45C1fb2fE532f490A"  // bad decimal
].map((a) => a.toLowerCase());
